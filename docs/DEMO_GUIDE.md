...
4. **Construction & Rebalancing — 20 seconds.** Compare current, equal, inverse-volatility, minimum-variance, and maximum-Sharpe weights; show the dollar buy/sell plan.
5. **Momentum and Stress — 20 seconds.** Point out the one-day signal lag, warm-up, transaction costs, direct per-asset shocks, and complete historical windows.
6. **Report — 10 seconds.** Show deterministic observations and the self-contained HTML/CSV exports.
